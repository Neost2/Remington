# CarePath Case Study #7

## Michelle (Parent Caregiver Using Medicaid Transportation)

## 1. Participant Profile

- Role: Parent caregiver
- Context: Uses Medicaid transportation for daughters
- Special requirement: Wheelchair-accessible van needed for at least one child
- Segment relevance: High-need caregiver segment with accessibility and provider-capacity dependency
